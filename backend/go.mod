module github.com/neuralops/platform

go 1.25.8

// The eBPF collector lives in a nested module (pkg/nexagent/ebpf/go.mod) so the
// default build graph does not pull github.com/cilium/ebpf. Build it with:
//   cd pkg/nexagent/ebpf && go build -tags ebpf .
...
require (
	...
	github.com/neuralops/platform/pkg/nexagent/ebpf v0.0.0
...
replace github.com/neuralops/platform/pkg/nexagent/ebpf => ./pkg/nexagent/ebpf
